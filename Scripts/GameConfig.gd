...
## How much an item's movement is reduced over time to bring it to a stop
@export var INVENTORY_ITEM_MOVE_DRAG : float = 0.69
## How much an item's rotation is reduced over time to bring it to a stop
@export var INVENTORY_ITEM_ROTATION_DRAG : float = 1.312
...
## How much more the item's movement is reduced over time to bring it to a stop (on top of INVENTORY_ITEM_MOVE_DRAG)
@export var ROCK_EXTRA_MOVE_DRAG : float = 0.0
## How much more the item's rotation is reduced over time to bring it to a stop (on top of INVENTORY_ITEM_ROTATION_DRAG)

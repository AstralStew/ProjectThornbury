...
func _fire() -> void:
	...
	_tween.tween_property(explosion,"scale",Vector2(0.02,0.02),1)
	...
	_tween.tween_property(explosion,"scale",Vector2(20,20),3)
	_tween.tween_property(explosion,"rotation",560,3)
	_tween.tween_property(explosion.get_child(1),"modulate",Color(Color.WHITE,0),3)
